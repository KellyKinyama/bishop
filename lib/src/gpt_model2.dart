...
class GptModel {
  ...
  Future<void> trainOnSequence(List<String> gameMoves) async {
    ...
    final List<ValueVector> logits = await decoder.forward(input, []);
    ...
    print('Trained on ${gameMoves.length} moves. Loss: ${batchLoss.data}');
  }
}
